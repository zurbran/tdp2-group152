...
CREATE TABLE IF NOT EXISTS `group152`.`viaje` (
  ...
  PRIMARY KEY (`id_viaje`, `horario_salida`),
...
CREATE TABLE IF NOT EXISTS `group152`.`combi_has_parada` (
  ...
  PRIMARY KEY (`hora`, `combi_id_combi`, `parada_id_parada`, `viaje_id_viaje`),
  INDEX `fk_combi_has_parada_parada1_idx` (`parada_id_parada` ASC),
  INDEX `fk_combi_has_parada_combi1_idx` (`combi_id_combi` ASC),
  INDEX `fk_combi_has_parada_viaje1_idx` (`viaje_id_viaje` ASC),
  ...
  CONSTRAINT `fk_combi_has_parada_viaje1`
